...
async function loadHots() {
    const data = await getAPI('/kpl/getstockconcepts/' + code, {});
    const hots = data['kpl_concept'].split(',');
    const kpl_hot_concept = data['kpl_hot_concept'].split(',');
    for (let i = 0; i < hots.length; i++) {
        let obj = { name: '', isHot: false };
        obj.name = hots[i];
...
function __VLS_template() {
    ...
    if (__VLS_ctx.isShow) {
        ...
        // @ts-ignore
        const __VLS_110 = __VLS_asFunctionalComponent(__VLS_109, new __VLS_109({ ...{ style: ({}) }, }));
        const __VLS_111 = __VLS_110({ ...{ style: ({}) }, }, ...__VLS_functionalComponentArgsRest(__VLS_110));
        ...
        // @ts-ignore
        const __VLS_124 = __VLS_asFunctionalComponent(__VLS_123, new __VLS_123({ ...{ class: ("contentdetail") }, label: ("分时"), name: ("mine"), lazy: (true), }));
        const __VLS_125 = __VLS_124({ ...{ class: ("contentdetail") }, label: ("分时"), name: ("mine"), lazy: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_124));
        ...
        /** @type { [typeof __VLS_components.ElTabPane, typeof __VLS_components.elTabPane, typeof __VLS_components.ElTabPane, typeof __VLS_components.elTabPane, ] } */
        // @ts-ignore
        const __VLS_136 = __VLS_asFunctionalComponent(__VLS_135, new __VLS_135({ ...{ class: ("contentdetail") }, label: ("五日"), name: ("fiveday"), lazy: (true), }));
        const __VLS_137 = __VLS_136({ ...{ class: ("contentdetail") }, label: ("五日"), name: ("fiveday"), lazy: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_136));
        ...
        /** @type { [typeof __VLS_components.ElTabPane, typeof __VLS_components.elTabPane, typeof __VLS_components.ElTabPane, typeof __VLS_components.elTabPane, ] } */
        // @ts-ignore
        const __VLS_148 = __VLS_asFunctionalComponent(__VLS_147, new __VLS_147({ ...{ class: ("contentdetail") }, label: ("日线"), name: ("day"), lazy: (true), }));
        const __VLS_149 = __VLS_148({ ...{ class: ("contentdetail") }, label: ("日线"), name: ("day"), lazy: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_148));
        ...
        var __VLS_120;
        const __VLS_159 = __VLS_resolvedLocalAndGlobalComponents.ElSpace;
        /** @type { [typeof __VLS_components.ElSpace, typeof __VLS_components.elSpace, typeof __VLS_components.ElSpace, typeof __VLS_components.elSpace, ] } */
        // @ts-ignore
        const __VLS_160 = __VLS_asFunctionalComponent(__VLS_159, new __VLS_159({ wrap: (true), }));
        const __VLS_161 = __VLS_160({ wrap: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_160));
        for (const [hot, index] of __VLS_getVForSourceType((__VLS_ctx.tags))) {
            __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ key: ((index)), });
            const __VLS_165 = __VLS_resolvedLocalAndGlobalComponents.ElTag;
            /** @type { [typeof __VLS_components.ElTag, typeof __VLS_components.elTag, typeof __VLS_components.ElTag, typeof __VLS_components.elTag, ] } */
            // @ts-ignore
            const __VLS_166 = __VLS_asFunctionalComponent(__VLS_165, new __VLS_165({ ...{ 'onClick': {} }, text: (true), ...{ class: (({ 'normal': !hot.isHot, 'hot': hot.isHot })) }, }));
            const __VLS_167 = __VLS_166({ ...{ 'onClick': {} }, text: (true), ...{ class: (({ 'normal': !hot.isHot, 'hot': hot.isHot })) }, }, ...__VLS_functionalComponentArgsRest(__VLS_166));
            let __VLS_171;
            const __VLS_172 = {
                onClick: (...[$event]) => {
                    if (!((__VLS_ctx.isShow)))
                        return;
                    __VLS_ctx.tagClick(hot.name);
                }
            };
            let __VLS_168;
            let __VLS_169;
    ...
    __VLS_styleScopedClasses['contentdetail'];
    __VLS_styleScopedClasses['contentdetail'];
    __VLS_styleScopedClasses['contentdetail'];
    __VLS_styleScopedClasses['normal'];
    __VLS_styleScopedClasses['hot'];
    var __VLS_slots;
...
//# sourceMappingURL=StockDetailView.vue.js.map